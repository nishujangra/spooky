...
- current product shape and operating assumptions
- trust boundaries and admin-plane expectations
- the conceptual model behind listeners, routes, upstreams, and backends
- how the data plane and control plane divide responsibilities
